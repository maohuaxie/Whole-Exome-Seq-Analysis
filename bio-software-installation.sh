please go to http://www.biotrainee.com:8080/thread-856-1-1.html check more details
...
echo 'export PATH=/home/maohuaxie/biosoft/myBin/bin:$PATH' >>~/.bashrc 
source ~/.bashrc
cd ~/biosoft
...
cd cmake-3.3.2 
./configure --prefix=/home/maohuaxie/biosoft/myBin
make
make install 
...
cd bcftools-1.3.1 
make
cp bcftools /home/maohuaxie/biosoft/myBin
...
# export PERL5LIB=/home/maohuaxie/biosoft/vcftools/vcftools-v0.1.14-24/src/perl/
# ./autogen.sh 
# ./configure     --prefix=/home/maohuaxie/biosoft/myBin
# make 
# make install 
...
cd weblogo
export PATH=$PATH:/home/maohuaxie/biosoft/weblogo/weblogo
source ~/.bashrc
...
echo 'export PATH=/home/maohuaxie/biosoft/ngsplot/ngsplot/bin:$PATH' >>~/.bashrc  
echo 'export NGSPLOT=/home/maohuaxie/biosoft/ngsplot/ngsplot' >>~/.bashrc 
source ~/.bashrc
